...
PATRICKS_SIZES = (50, 38)
PATRICKS_SIZE_RANDOMIZE = (1,2) # for each new mosquito, it will multiply the size with an random value beteewn X and Y
SPONGEBOB_SIZES = (50, 50)
SPONGEBOB_SIZE_RANDOMIZE = (1.2, 1.5)
...
PATRICKS_SPAWN_TIME = 1
PATRICKS_MOVE_SPEED = {"min": 1, "max": 5}
SPONGEBOB_PENALITY = 1 # will remove X of the score of the player (if he kills a bee)
